...
const ICON = {
  ...
  proofs: <ShieldCheck className="h-4 w-4" />,
  announcements: <Megaphone className="h-4 w-4" />,
  reports: <BarChart3 className="h-4 w-4" />,
  notifications: <Bell className="h-4 w-4" />,
  audit: <Archive className="h-4 w-4" />,
  settings: <Settings className="h-4 w-4" />,
  profile: <UserSquare2 className="h-4 w-4" />,
  upload: <UploadCloud className="h-4 w-4" />,
  clients: <FolderKanban className="h-4 w-4" />,
};
...
export default function SidebarDrawer({
  ...
  return (
    ...
    >
      ...
      <button
        aria-hidden
        className="absolute -right-3 top-4 rounded-full border bg-background p-1 shadow md:hidden"
        onClick={handleOpen}
      />
    </aside>
  );
